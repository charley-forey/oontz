...
files.forEach(function(f){
  A.ok(fs.readFileSync(path.join(eng, f)).equals(fs.readFileSync(path.join(app, f))),
...
A.ok(/const API = "https?:\/\/[^"]+"/.test(html), "server.py reads the API base from index.html's `const API = \"...\"` line");
